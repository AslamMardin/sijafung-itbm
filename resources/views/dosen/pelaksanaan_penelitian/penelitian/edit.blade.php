...
@section('page-title', 'Edit Penelitian')
...
<div class="card">
    ...
    <form action="{{ route('dosen.penelitian.update', ['penelitian', $penelitian]) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="number" name="tahun_pelaksanaan" id="tahun_pelaksanaan" class="form-control @error('tahun_pelaksanaan') is-invalid @enderror"
                               value="{{ old('tahun_pelaksanaan', $penelitian->tahun_pelaksanaan) }}" min="2000" max="{{ date('Y') + 1 }}" required>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="afiliasi" id="afiliasi" class="form-control"
                       value="{{ old('afiliasi', $penelitian->afiliasi) }}">
            </div>
                ...
                <div class="col-md-4">
                    <div class="form-group mb-3">
                        ...
                        <select name="peran" id="peran" class="form-control @error('peran') is-invalid @enderror" required>
                            ...
                            <option value="ketua" {{ old('peran', $penelitian->peran) == 'ketua' ? 'selected' : '' }}>Ketua</option>
                            <option value="anggota" {{ old('peran', $penelitian->peran) == 'anggota' ? 'selected' : '' }}>Anggota</option>
                        </select>
                        @error('peran')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="col-md-4">
                    <div class="form-group mb-3">
                        ...
                        <input type="number" name="lama_kegiatan_tahun" id="lama_kegiatan_tahun" class="form-control"
                               value="{{ old('lama_kegiatan_tahun', $penelitian->lama_kegiatan_tahun) }}" min="0" step="0.5">
                    </div>
                </div>
            </div>
            ...
            <div class="alert alert-warning">
                ...
                <input type="url" name="link_dokumen" id="link_dokumen" class="form-control @error('link_dokumen') is-invalid @enderror" 
                       value="{{ old('link_dokumen', $penelitian->link_dokumen) }}" placeholder="https://drive.google.com/...">
                @error('link_dokumen')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
