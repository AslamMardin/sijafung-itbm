                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if ($kegiatan->link_dokumen)
                                        <a href="{{ $kegiatan->link_dokumen }}" target="_blank" title="Buka Link Dokumen"
                                            class="ms-1" style="color: #007bff;">
                                ...
                                <td><strong
                                        style="color: var(--maroon);">{{ number_format($kegiatan->angka_kredit, 2) }}</strong>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        @if ($kegiatan->status == 'Pending')
                                            <a href="{{ route('dosen.pendidikan.edit', [$kegiatan->jenis_kegiatan, $kegiatan]) }}"
                                                class="btn btn-sm btn-outline">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                        @endif
                                        <form action="{{ route('dosen.pendidikan.destroy', $kegiatan) }}" method="POST"
                                            class="d-inline">
                                            @csrf
                                            @method('DELETE')
