@extends('layouts.app')
@section('title', 'Edit Detasering')
@section('page-title', 'Edit Detasering')

@section('content')
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Form Edit Detasering</h3>
        <a href="{{ route('dosen.pendidikan.index') }}" class="btn btn-outline btn-sm">
            <i class="fas fa-arrow-left"></i> Kembali
        </a>
    </div>

    <form action="{{ route('dosen.pendidikan.update', ['detasering', $pendidikan]) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="date" name="tanggal_sk_penugasan" id="tanggal_sk_penugasan" class="form-control"
                               value="{{ old('tanggal_sk_penugasan', $pendidikan->tanggal_sk_penugasan?->format('Y-m-d')) }}">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="perguruan_tinggi_sasaran" id="perguruan_tinggi_sasaran" class="form-control @error('perguruan_tinggi_sasaran') is-invalid @enderror"
                       value="{{ old('perguruan_tinggi_sasaran', $pendidikan->perguruan_tinggi_sasaran) }}" required placeholder="Nama perguruan tinggi sasaran">
            ...
            <div class="form-group mb-3">
                ...
                <textarea name="deskripsi_kegiatan" id="deskripsi_kegiatan" rows="4"
                          ...
                          required placeholder="Deskripsi kegiatan detasering">{{ old('deskripsi_kegiatan', $pendidikan->deskripsi_kegiatan) }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="metode_pelaksanaan" id="metode_pelaksanaan" class="form-control"
                               value="{{ old('metode_pelaksanaan', $pendidikan->metode_pelaksanaan) }}" placeholder="Metode pelaksanaan">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="nomor_sk_penugasan" id="nomor_sk_penugasan" class="form-control"
                               value="{{ old('nomor_sk_penugasan', $pendidikan->nomor_sk_penugasan) }}" placeholder="Nomor SK penugasan">
                    </div>
                </div>
            </div>
