@extends('layouts.app')
@section('title', 'Edit Visiting Scientist')
@section('page-title', 'Edit Visiting Scientist')

@section('content')
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Form Edit Visiting Scientist</h3>
        <a href="{{ route('dosen.pendidikan.index') }}" class="btn btn-outline btn-sm">
            <i class="fas fa-arrow-left"></i> Kembali
        </a>
    </div>

    <form action="{{ route('dosen.pendidikan.update', ['visiting_scientist', $pendidikan]) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="card-body">
            <div class="row">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="perguruan_tinggi_pengundang" id="perguruan_tinggi_pengundang" class="form-control @error('perguruan_tinggi_pengundang') is-invalid @enderror"
                       value="{{ old('perguruan_tinggi_pengundang', $pendidikan->perguruan_tinggi_pengundang) }}" required placeholder="Nama perguruan tinggi pengundang">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="number" name="lama_kegiatan_hari" id="lama_kegiatan_hari" class="form-control @error('lama_kegiatan_hari') is-invalid @enderror"
                               value="{{ old('lama_kegiatan_hari', $pendidikan->lama_kegiatan_hari) }}" min="1" required placeholder="Durasi dalam hari">
